            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-2 mb-3">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase
                                bg-amber-500/10 border border-amber-500/30 text-amber-700 dark:!text-amber-400 shadow-[0_0_12px_rgba(245,158,11,0.2)]">
                    ...
                    <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium
                                bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:!text-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.2)]">
                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                        Cloud Connected • Vercel Active
                    </div>
                </div>

                <!-- Main Greeting Title with Cyber Metallic Gradient -->
                <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:cyber-metallic-text">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="/kelola/photos/create" 
                   class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-xs transition-all duration-300
                          ...
                          text-gray-950 shadow-[0_0_20px_rgba(245,158,11,0.4)] hover:-translate-y-0.5 active:scale-95">
